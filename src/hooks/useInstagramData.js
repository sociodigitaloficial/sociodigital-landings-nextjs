...
const useInstagramData = () => {
  ...
  const head = {
    ...
    title: 'Publicidad por Instagram | Socio Digital',
    description: 'Realiza una campaña de publicidad digital por Instagram, con el objetivo exclusivo de captar potenciales clientes. Somos expertos diseñando campañas para empresas, amplia experiencia y excelente precio, ¡Consulta!',
  ...
  const presentation = {
    ...
    section: {
      id: 'presentation',
      title: `Realiza <strong style="color: ${color.dorado}">PUBLICIDAD</strong> para tu PYME por <strong style="color: ${color.dorado}">INSTAGRAM</strong>`,
    },
  ...
  const carousel = {
    ...
    content: [
      {   
        ...
        title: 'Anuncios',
        paragraph:'Publicamos anuncios de tu PYME en Instagram para cada servicio o producto que ofreces, puede ser mediante anuncios clásicos o de catálogo respectivamente. <b>Hacemos cuantos anuncios sean necesarios para vender.</b>',
        width: ['280px', '250px'] 
      },
      {
        id: "element2",
        ...
        title: 'Rentabilidad',
        paragraph:'Nuestro enfoque está en publicar y vender, sin rodeos, queremos que obtengas resultados rápidos para que sigas haciendo publicidad con nosotros. <b>No nos fijamos en la cantidad de visitas al sitio, nuestra meta son las ventas obtenidas.</b>',
        width: ['280px', '250px'] 
      },
      {
        id: "element3",
  ...
  const carousel2 = {
    ...
    section: {
      id: 'carousel2',
      title: `Así funciona nuestra <strong style="color: ${color.dorado}">PUBLICIDAD DIGITAL</strong> por <strong style="color: ${color.dorado}">INSTAGRAM</strong>`,
    ...
    content: [
      {   
        ...
        title: 'Paso 1',
        paragraph:'El nicho de mercado ve tus anuncios por Instagram, ya sea una anuncio simple o de catálogo, <b>se interesa por el servicio o producto que ofreces</b> y les da clic a los anuncios.',
        width: ['280px', '300px'] 
      },
      {
        id: "element2",
  ...
  const callForLoss = {
    ...
    content: {
      ...
      paragraph: 'Déjanos tus datos, te contactaremos y conversaremos sobre la manera en que la publicidad por Instagram te ayudará a aumentar las ventas, no dejes pasar más tiempo ni te quedes con las dudas.',
      href: '#form',
      button: 'ME INTERESA'
    }
