        ...
        <div id={content.id}>
            {loanding ?
                ...
                <form id="form" className='form'>
                    ...
                    {content.name && <input className="name" type="text" name="form-name" placeholder={content.name} required/>}
                    {content.phone && <input className="phone" type="text" name="form-phone" placeholder={content.phone} required/>}
                    {content.email && <input className="email" type="email" name="form-email" placeholder={content.email} required/>}
                    {content.message && <textarea className="message" name="form-message" placeholder={content.message} required/>}
